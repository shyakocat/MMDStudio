...
THREE.MMDLoader.prototype.loadModel = function (url, callback, onProgress, onError, _tp, _me) {

    var scope = this;

    var texturePath = _tp ? _tp : this.extractUrlBase(url);
    var modelExtension = _me ? _me : this.extractExtension(url);
...
THREE.MMDLoader.prototype.createMesh = function (model, texturePath, onProgress, onError) {
    ...
    var initMaterials = function () {
        ...
        //var textureLoader = new TextureUtil.TextureLoader(this.manager);
